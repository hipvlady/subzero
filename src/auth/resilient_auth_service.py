...
from src.auth.auth0_integration import Auth0IntegrationManager, Auth0Configuration
from src.security.health_monitor import Auth0HealthMonitor
from src.security.graceful_degradation import GracefulDegradationService, DegradedMode, CacheSource
    ...
    def get_service_metrics(self) -> Dict:
        ...
        if self.metrics['total_authz_checks'] > 0:
            authz_success_rate = (
                ...
                self.metrics['total_authz_checks'] * 100
            )
