...
class DynamicCapabilityRegistry:
    ...
    async def discover_capabilities(
        ...
        complexity_max: Optional[OperationComplexity] = None
        ...
        if complexity_max:
            ...
            capabilities = [
                cap for cap in capabilities
                if complexity_order[cap.complexity] <= max_level
            ]
    ...
    async def execute_workflow(
        ...
        for step in workflow.steps:
            ...
            step_input = {
                param: workflow_context.get(source_var)
                for param, source_var in step.input_mapping.items()
            }
    ...
    def get_registry_metrics(self) -> Dict:
        ...
        return {
            ...
            'capabilities_by_complexity': {
                complexity.value: sum(
                    1 for cap in self.capabilities.values()
                    if cap.complexity == complexity
                )
